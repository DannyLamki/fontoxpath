...
import { ValidValue, ValidValueSequence } from '../types/TypedValueFactory';
...
function checkNumericType(value: ValidValue, type: ValueType): value is number {
